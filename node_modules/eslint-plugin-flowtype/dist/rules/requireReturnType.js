...
var create = function create(context) {
  ...
  var evaluateFunction = function evaluateFunction(functionNode) {
    ...
    var isFunctionReturnUndefined = !isArrowFunctionExpression && !(functionNode.generator && !functionNode.async) && (!targetNode.returnStatementNode || isUndefinedReturnType(targetNode.returnStatementNode));
